...
Hence, the computational cost increases three-fold assuming that the three-dimensional mesh is an extrusion of a two-dimensional mesh, having prismatic cells arranged in columns.}
