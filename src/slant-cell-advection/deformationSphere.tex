...
\TODO{we use this test to find the ``minimal'' resolution.  state what this is for cubicFit (and linearUpwind?) and perhaps compare to similar schemes.  mention that \citep{lauritzen2014} has collated minimal resolutions for a number of other schemes.}
