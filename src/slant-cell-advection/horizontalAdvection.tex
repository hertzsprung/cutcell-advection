...
\revone{The cubicFit scheme achieves a given $\ell_2$ error using a mesh spacing that is almost double that needed by the linearUpwind scheme.  Doubling the mesh spacing results in a mesh with four times fewer cells because the $\Delta x \mathbin{:} \Delta z$ aspect ratio is fixed.
