...
\begin{figure}
	...
	\caption{Illustrations of coarse meshes of a spherical Earth using (a) a hexagonal icosahedron and (b) a cubed-sphere.  \TODO{say what refinement level the hex mesh is.}  Each panel of the cubed-sphere has $8 \times 8$ cells.}
...
\TODO{in an appendix, describe OpenFOAM's global Cartesian coordinates, one-cell deep atmosphere, and our correction for spherical geometry?}
