...
\end{comment}
\end{quotation}
We had incorrectly assumed that the stability would be $\mathrm{Co} = 1.0$ but, after further experimentation, we have found the limit of stability is about $\mathrm{Co} = $ \TODO{2.n}.  \TODO{Section 3.2 has been revised to reflect this new finding}.
