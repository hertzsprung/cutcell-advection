...
\end{comment}
\end{quotation}
We haven't explored triangular meshes in this paper, and more work would be needed to evaluate the suitability of stencils and stability criteria on these meshes.  We would not expect the stencil topology to change for triangles that are slightly perturbed from equilateral because such triangles will always have two opposing faces as given by equations (6) and (8).
