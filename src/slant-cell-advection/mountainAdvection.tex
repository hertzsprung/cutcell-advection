...
\begin{figure}
	...
	\caption{\TODO{evolution of the slug over a mountain at $t=0$, $t=T/2$ and $t=T$.  Tracer contours 0.1.} \\
...
\begin{figure}
	...
	\caption{\TODO{mountain advection error contours for (left-to-right) BTF, cut cells and slanted cells; linearUpwind (top) and cubicFit (bottom).  Error contours 0.01.} \\
