...
\end{align}
where $\tilde{\phi_F}$ is linearly interpolated from the two neighbouring cells of face $f$.  This implementation of the linearUpwind scheme is included in the OpenFOAM software distribution \citep{openfoam}.
