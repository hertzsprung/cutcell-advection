...
\end{align}
\TODO{I still don't know where this comes from.  I would have calculated the centre of mass as follows: let $r_c$ be the radius of the cell centre, lying somewhere between $r_1$ and $r_2$.  The volume of the inner shell must be equal to the volume of the outer shell, so}
\begin{align}
	\frac{4}{3} \pi \left( r_2^3 - r_c^3 \right) = \frac{4}{3} \pi \left( r_c^3 - r_1^3 \right) \\
	r_c = \sqrt[3]{\frac{r_1^3 + r_2^3}{2}}
\end{align}
