...
If there are multiple candidates with the same number of terms, the candidate with the largest minimum singular value of $\mathbf{B}$ is preferred.  This ordering ensures that the preferred candidate is the highest-order polynomial with the most information content.
