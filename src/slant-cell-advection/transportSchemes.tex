...
The time derivative is discretised using a two-stage, second-order Runge-Kutta method, \TODO{we should use a two-stage, second-order Heun scheme, not the mid-point scheme described below}
\begin{subequations}
\begin{align}
