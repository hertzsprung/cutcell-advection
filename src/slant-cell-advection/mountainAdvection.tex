...
Since the cubicFit transport scheme uses values at boundaries with Dirichlet boundary conditions, only inlet boundary values are included in this test case.
