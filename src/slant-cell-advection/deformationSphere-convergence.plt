...
plot "`echo $ATMOSTESTS_DIR`/build/deformationSphere-gaussians-nondiv-linearUpwind-hex-collated/1.0368e+06/l2errorT.txt" using 1:2 title 'hex linearUpwind', \
     ...
     "`echo $ATMOSTESTS_DIR`/build/deformationSphere-gaussians-nondiv-linearUpwind-tri-collated/1.0368e+06/l2errorT.txt" using 1:2 title 'tri linearUpwind', \
     "`echo $ATMOSTESTS_DIR`/build/deformationSphere-gaussians-nondiv-cubicUpwind-tri-collated/1.0368e+06/l2errorT.txt" using 1:2 title 'tri cubicUpwind', \
...
plot "`echo $ATMOSTESTS_DIR`/build/deformationSphere-gaussians-nondiv-linearUpwind-hex-collated/1.0368e+06/linferrorT.txt" using 1:2 title 'hex linearUpwind', \
     ...
     "`echo $ATMOSTESTS_DIR`/build/deformationSphere-gaussians-nondiv-linearUpwind-tri-collated/1.0368e+06/linferrorT.txt" using 1:2 title 'tri linearUpwind', \
     "`echo $ATMOSTESTS_DIR`/build/deformationSphere-gaussians-nondiv-cubicUpwind-tri-collated/1.0368e+06/linferrorT.txt" using 1:2 title 'tri cubicUpwind', \
     x * 1e-1 lc rgbcolor "black" dt 1 lw 1 title '1st order', \
     x**2 * 1e-1 lc rgbcolor "black" dt 3 lw 3 title '2nd order'
