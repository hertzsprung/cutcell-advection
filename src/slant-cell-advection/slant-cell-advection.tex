...
%The approximate value is found by a least squares fit of a multidimensional polynomial over an upwind-biased stencil of cell centre values.
...
% now we can start talking about polynomials
