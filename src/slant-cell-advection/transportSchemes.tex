...
Although the Heun method is unstable for a zero-dimensional linear oscillator and for solving the transport equation using centred, linear differencing, it is stable when it is used for transport schemes with some upwinding.  \TODO{Hilary: can you confirm this statement applies to the time-stepping scheme given here, and not the midpoint scheme I was previously using?  Also, does this need a citation?}
