...
\end{align}
\TODO{in this case we use a more general method for identifying surface faces than we used for face correction.  we should use the general method in all cases and update this description accordingly.  raised \url{https://trello.com/c/anBhIy60/812-change-cell-centre-spherical-correction-to-be-consistent-with-edge-and-face-centres} for this.}
