...
\end{align}
We know that we want $|A|^2 \leq 1$ and figure~\ref{fig:forward-euler} shows that this condition is never quite met for all wavenumbers, although using $c \leq 0.01$ is only weakly unstable.
