...
A boundary condition of $\phi = \SI{0}{\kilo\gram\per\meter\cubed}$ is imposed at the inlet and the outlet, ground and top boundary conditions are $\partial \phi / \partial n = \SI{0}{\kilo\gram\per\meter\tothe{4}}$ where the derivative is normal to the boundary.
