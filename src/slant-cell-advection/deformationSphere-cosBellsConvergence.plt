...
set label "CSLAM-CN5.5" at 1.5,0.033 center point pt 7 ps 2 offset character -2,-1.1
set label "FARSIGHT" at 0.1875,0.033 center point pt 5 ps 2 offset character 0,0.7

plot "`echo $ATMOSTESTS_DIR`/build/deformationSphere-cosBells-nondiv-linearUpwind-hex-collated/1.0368e+06/l2errorT.txt" using 1:2 lc 1 dt 3 lw 2 title 'Icosahedral linearUpwind', \
     "`echo $ATMOSTESTS_DIR`/build/deformationSphere-cosBells-nondiv-cubicUpwind-hex-collated/1.0368e+06/l2errorT.txt" using 1:2 lc 1 title 'Icosahedral cubicFit', \
