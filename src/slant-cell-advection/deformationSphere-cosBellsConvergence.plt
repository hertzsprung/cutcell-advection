...
plot "`echo $ATMOSTESTS_DIR`/build/deformationSphere-cosBells-nondiv-linearUpwind-hex-collated/1.0368e+06/l2errorT.txt" using 1:2 lc 1 dt 3 lw 2 title 'hex linearUpwind', \
     "`echo $ATMOSTESTS_DIR`/build/deformationSphere-cosBells-nondiv-cubicUpwind-hex-collated/1.0368e+06/l2errorT.txt" using 1:2 lc 1 title 'hex cubicUpwind', \
     ...
     "`echo $ATMOSTESTS_DIR`/build/deformationSphere-cosBells-nondiv-cubicUpwind-quad-collated/1.0368e+06/l2errorT.txt" using 1:2 lc 2 title 'quad cubicUpwind', \
