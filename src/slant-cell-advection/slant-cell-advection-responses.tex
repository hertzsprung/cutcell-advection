...
\end{itemize}
I have cubicFit working in 3D with a blob advected in a 3D diagonal velocity field on a BTF mesh.
}
...
\end{comment}
\end{quotation}
We had incorrectly assumed that the stability would be $\mathrm{Co} = 1.0$ but, after further experimentation, we have found the limit of stability \TODO{between about 1.3 and 3.3}.  \TODO{Section 3.2 and figure 10 have been revised to present the maximum time-steps that have been now been found experimentally.}.
