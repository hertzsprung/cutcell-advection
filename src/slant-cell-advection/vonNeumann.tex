...
We hypothesise that the three stability constraints (equations~\ref{eqn:vn:upwind}, \ref{eqn:vn:downwind} and \ref{eqn:uuConstraint}) are necessary \TODO{but not sufficient?  they are sufficient in our tests} for a transport scheme on arbitrarily-structured meshes.
