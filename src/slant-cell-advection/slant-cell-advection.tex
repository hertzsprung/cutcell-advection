...
\TODO{include convergence plot of horizontal advection over highly-distorted BTF grid, compare linearUpwind and cubicFit.  Maybe use $h_0 = \SI{6}{\kilo\meter}$.  Should demonstrate that cubicFit is second-order even on highly-distorted meshes.}
