...
Section 2.1.4 has been reworded to say, ``\revtwo{To avoid numerical instabilities, an idealised, one-dimensional von Neumann analysis was performed, presented in appendix A.  The analysis is used to impose three stability constraints on the weights $\mathbf{w}$}''.
